...
class FetchFavoriteSurahs implements Usecase<List<Surah>, Unit> {
  final SurahRepository surahRepository;

  FetchFavoriteSurahs(this.surahRepository);
  @override
  Future<Either<Failure, List<Surah>>> call(Unit params) async {
    return await surahRepository.fetchAllFavoritesSurahs();
  }
}
